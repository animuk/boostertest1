...
----
$ git clone git@github.com:animuk/boostertest1
...
== More Information
You can learn more about this booster and the vert.x runtime in the link:http://appdev.openshift.io/docs/vertx-runtime.html[vert.x Runtime Guide].
